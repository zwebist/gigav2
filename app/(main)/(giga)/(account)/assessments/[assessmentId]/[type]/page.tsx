'use client';
import { getAssessmentByIdandListType } from '@/actions/Assessments/Assessment';
...
function AssessmentType() {
    ...
    const listItem = useMemo(() => {
        return getAssessmentByIdandListType({ id: params.assessmentId || '', ListType: params.type || '' });
    }, [params.assessmentId, params.type]);
